...
flash: $(FW_FILE)
	$(ESPTOOL) -p $(ESPPORT) --baud $(ESPBAUD) write_flash $(ESPTOOL_ARGS) 0x0 $(RBOOT_BIN) 0x1000 $(RBOOT_CONF) 0x202000 $(FW_FILE) 0x2000 /home/hawk/esp-open-rtos/eagle.app.v6.bin
